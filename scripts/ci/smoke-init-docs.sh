...
assert_contains "docs/examples/next.md" "Next Example"
assert_contains "docs/examples/next.md" "npx create-quiver next --auto-start"
...
assert_contains "README.md" "AI-First Workflow"
assert_contains "README.md" "planner agent reads the project context"
assert_contains "README.md" "npm run quiver:ai:plan -- --phase technical-plan"
assert_contains "README.md" "npm run quiver:plan"
assert_contains "README.md" "npm run quiver:graph"
assert_contains "README.md" "npm run quiver:next"
assert_contains "README.md" "npx create-quiver next"
...
assert_contains "docs/AI_ONBOARDING_PROMPT.md" ".quiver/scans/PROJECT_SCAN.json"
