...
The v30 spec is planned under `specs/quiver-v30-interactive-cli-ux-agent-selection/`; it targets production-grade interactive CLI UX with visible IA progress, Quiver-branded output, configured Planner/Executor/Reviewer/Doctor selectors, real provider model-selection contracts, Doctor human/JSON parity, and cross-platform release readiness.
