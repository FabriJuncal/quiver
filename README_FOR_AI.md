...
The v26 hotfix spec is planned under `specs/quiver-v26-0121-smoke-hardening/`; it targets `0.12.1` smoke hardening for CLI help/version output, generated doc links, AI approval/review guidance, local validation, slice brief validation, demo readiness, and release smoke coverage. Do not treat v26 as implemented until its implementation slices are completed.
