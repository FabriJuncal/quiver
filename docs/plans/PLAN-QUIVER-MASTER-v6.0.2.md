---
title: "Quiver — Roadmap Maestro v6.0.2: plan de iniciativa A"
...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./PLAN-QUIVER-MASTER-v6.0.1.md"
base_plan:
  artifact_id: "PLAN-QUIVER-MASTER"
  version: "6.0"
...
requirements:
  ...
  - artifact_id: "REQ-QUIVER-INIT-B-STUDIO-ALPHA"
    version: "1.0.0"
    path: "../requirements/initiatives/REQ-QUIVER-INIT-B-STUDIO-ALPHA-v1.0.0.md"
  - artifact_id: "REQ-QUIVER-INIT-C-OBSERVER-CONTROL"
    version: "1.0.0"
    path: "../requirements/initiatives/REQ-QUIVER-INIT-C-OBSERVER-CONTROL-v1.0.0.md"
...
child_plans:
  - artifact_id: "PLAN-QUIVER-INIT-A-ENGINE-TRUST"
    version: "1.0.0"
    path: "./PLAN-QUIVER-INIT-A-ENGINE-TRUST-v1.0.0.md"
decisions:
...
# Quiver — Roadmap Maestro v6.0.2

## Contrato efectivo

Esta revisión mantiene íntegros la visión, arquitectura, orden, alcance, estados,
dependencias y criterios del
[Roadmap Maestro v6.0](./Quiver_Roadmap_Maestro_v6.md). Conserva las tres
aclaraciones de v6.0.1 y agrega un único cambio de gobernanza:
...
4. vincular el plan específico propuesto para la iniciativa A.

## Binding de iniciativas

| Segmento | Requerimiento | Specs | Gate canónico |
|---|---|---:|---|
| A | `REQ-QUIVER-INIT-A-ENGINE-TRUST@1.0.1` | V58–V62 | Sin gate comercial de entrada; las dependencias por spec siguen siendo obligatorias. |
| B | `REQ-QUIVER-INIT-B-STUDIO-ALPHA@1.0.0` | V63–V70 | G1 se evalúa después de SPEC-V70 y antes de ampliar Observer/Control. |
| C | `REQ-QUIVER-INIT-C-OBSERVER-CONTROL@1.0.0` | V71–V76 | G1 precede SPEC-V71; G2 precede SPEC-V75. |
...
- [REQ-QUIVER-PRODUCT-CATALOG@6.0.2](../requirements/REQ-QUIVER-PRODUCT-CATALOG-v6.0.2.md)
- [PLAN-QUIVER-INIT-A-ENGINE-TRUST@1.0.0](./PLAN-QUIVER-INIT-A-ENGINE-TRUST-v1.0.0.md)
