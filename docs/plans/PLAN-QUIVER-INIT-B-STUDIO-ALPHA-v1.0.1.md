...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./PLAN-QUIVER-INIT-B-STUDIO-ALPHA-v1.0.0.md"
requirements:
...
parent_plan:
  ...
  version: "6.0.5"
  path: "./PLAN-QUIVER-MASTER-v6.0.5.md"
decisions:
...
2. el binding de B de `PLAN-QUIVER-MASTER@6.0.5`, sin aprobar el roadmap completo
   ni las iniciativas C–G;
3. `PLAN-QUIVER-INIT-B-STUDIO-ALPHA@1.0.1`.

Frase sugerida:

> Apruebo la cadena documental B: REQ-B 1.0.1, binding maestro 6.0.5 y PLAN-B
> 1.0.1.
