...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./PLAN-QUIVER-INIT-C-OBSERVER-CONTROL-v1.0.0.md"
requirements:
...
parent_plan:
  ...
  version: "6.0.8"
  path: "./PLAN-QUIVER-MASTER-v6.0.8.md"
decisions:
...
2. el binding de C de `PLAN-QUIVER-MASTER@6.0.8`, sin aprobar el roadmap completo
   ni las iniciativas D–G;
3. `PLAN-QUIVER-INIT-C-OBSERVER-CONTROL@1.0.1`.

Frase sugerida:

> Apruebo la cadena documental C: REQ-C 1.0.1, binding maestro 6.0.8 y PLAN-C
> 1.0.1.
