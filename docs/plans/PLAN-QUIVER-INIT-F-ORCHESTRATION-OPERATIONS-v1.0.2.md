...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./PLAN-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS-v1.0.1.md"
requirements:
...
parent_plan:
  ...
  version: "6.0.18"
  path: "./PLAN-QUIVER-MASTER-v6.0.18.md"
decisions:
...
1. `REQ-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS@1.0.2`;
2. el binding de F de `PLAN-QUIVER-MASTER@6.0.18`, sin aprobar el roadmap
   completo, la iniciativa G o G5;
3. `PLAN-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS@1.0.2`.
