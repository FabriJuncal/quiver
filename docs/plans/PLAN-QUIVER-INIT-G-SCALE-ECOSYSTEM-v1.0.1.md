...
owner: "Fabri Juncal"
date: "2026-09-04"
supersedes: "./PLAN-QUIVER-INIT-G-SCALE-ECOSYSTEM-v1.0.0.md"
requirements:
...
parent_plan:
  ...
  version: "6.0.21"
  path: "./PLAN-QUIVER-MASTER-v6.0.21.md"
decisions:
...
2. el binding de G de `PLAN-QUIVER-MASTER@6.0.21`, sin aprobar el roadmap
   completo ni demostrar los gates de V89–V92;
3. `PLAN-QUIVER-INIT-G-SCALE-ECOSYSTEM@1.0.1`.
