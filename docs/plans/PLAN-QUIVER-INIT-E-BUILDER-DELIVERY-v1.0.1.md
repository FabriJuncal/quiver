...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./PLAN-QUIVER-INIT-E-BUILDER-DELIVERY-v1.0.0.md"
requirements:
...
parent_plan:
  ...
  version: "6.0.14"
  path: "./PLAN-QUIVER-MASTER-v6.0.14.md"
decisions:
...
2. el binding de E de `PLAN-QUIVER-MASTER@6.0.14`, sin aprobar el roadmap
   completo ni las iniciativas F–G;
3. `PLAN-QUIVER-INIT-E-BUILDER-DELIVERY@1.0.1`.
