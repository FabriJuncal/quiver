...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./PLAN-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS-v1.0.2.md"
requirements:
...
parent_plan:
  ...
  version: "6.0.19"
  path: "./PLAN-QUIVER-MASTER-v6.0.19.md"
decisions:
  ...
  - decision_id: "DEC-20260903-075"
    date: "2026-09-03"
    actor: "technical-agent"
    change: "Actualizar bindings a REQ-F 1.0.2 y maestro 6.0.18"
    reason: "Cerrar PLAN-F-REV-01 con navegación canónica sin referencias reemplazadas"
    impact: "Mantiene íntegros alcance, riesgos, validación y los 22 RQs; F y G5 continúan sin aprobación"
  - decision_id: "DEC-20260903-079"
    date: "2026-09-03"
    actor: "project-owner"
    change: "Aprobar el plan de la iniciativa F"
    reason: "Aprobación explícita de REQ-F 1.0.2, binding maestro 6.0.18 y PLAN-F 1.0.2"
    impact: "Crea PLAN-F 1.0.3 aprobado y habilita planificar G; no inicia implementación ni aprueba G5"
---
...
- congela dependencias, bifurcaciones y obligaciones de evidencia de F;
- habilita materializar cada spec solo después de cerrar sus dependencias;
- no decide G5 ni selecciona, compra o construye un orchestrator;
- no habilita workflows productivos, integraciones, incident automation,
  auto-merge, auto-rollback, producción, release o deploy;
- habilita continuar documentalmente con el plan de la iniciativa G.
...
El project owner nombró los tres elementos y aprobó solamente el binding de F:

1. `REQ-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS@1.0.3`;
2. el binding de F de `PLAN-QUIVER-MASTER@6.0.19`, sin aprobar el roadmap
   completo, la iniciativa G o G5;
3. `PLAN-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS@1.0.3`.

Frase registrada:

> Apruebo la cadena documental F: REQ-F 1.0.2, binding maestro 6.0.18 y PLAN-F
> 1.0.2.

La aprobación queda persistida como sucesores versionados en el orden
requirement → master/catalog binding → plan. No es transitiva, no aprueba G5 y
