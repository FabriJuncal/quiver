---
title: "Quiver — Catálogo segmentado de especificaciones y requerimientos v6.0.4"
...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./REQ-QUIVER-PRODUCT-CATALOG-v6.0.3.md"
related_plans:
...
initiatives:
  ...
  - artifact_id: "REQ-QUIVER-INIT-B-STUDIO-ALPHA"
    version: "1.0.1"
    path: "./initiatives/REQ-QUIVER-INIT-B-STUDIO-ALPHA-v1.0.1.md"
...
# Quiver — Catálogo segmentado de requerimientos v6.0.4

## 0. Cómo usar este catálogo

Este archivo reemplaza v6.0.3 como punto de entrada operativo. Vincula la
revisión aprobada 1.0.3 de A y la revisión propuesta 1.0.1 de B con su plan. El
contenido continúa distribuido en siete iniciativas versionables, sin cambios
de alcance.
...
| B | `REQ-QUIVER-INIT-B-STUDIO-ALPHA` | V63–V70 | 80 | [REQ-QUIVER-INIT-B-STUDIO-ALPHA-v1.0.1.md](./initiatives/REQ-QUIVER-INIT-B-STUDIO-ALPHA-v1.0.1.md) |
...
orden y gates es el
[plan maestro v6.0.4](../plans/PLAN-QUIVER-MASTER-v6.0.4.md).
