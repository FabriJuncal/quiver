---
title: "Quiver — Catálogo segmentado de especificaciones y requerimientos v6.0.15"
...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./REQ-QUIVER-PRODUCT-CATALOG-v6.0.14.md"
related_plans:
...
initiatives:
  ...
  - artifact_id: "REQ-QUIVER-INIT-G-SCALE-ECOSYSTEM"
    version: "1.0.1"
    path: "./initiatives/REQ-QUIVER-INIT-G-SCALE-ECOSYSTEM-v1.0.1.md"
decisions:
...
# Quiver — Catálogo segmentado de requerimientos v6.0.15

## 0. Cómo usar este catálogo

Este archivo reemplaza v6.0.14 como punto de entrada operativo. Vincula las
revisiones aprobadas 1.0.3 de A y F, y 1.0.2 de B, C, D y E con sus planes, y
la revisión propuesta 1.0.1 de G con su plan. El contenido permanece distribuido
en siete iniciativas versionables, sin cambios de alcance.
...
| G | `REQ-QUIVER-INIT-G-SCALE-ECOSYSTEM` | V89–V92 | 32 | [REQ-QUIVER-INIT-G-SCALE-ECOSYSTEM-v1.0.1.md](./initiatives/REQ-QUIVER-INIT-G-SCALE-ECOSYSTEM-v1.0.1.md) |
