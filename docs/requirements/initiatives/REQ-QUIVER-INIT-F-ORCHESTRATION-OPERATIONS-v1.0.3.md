...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./REQ-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS-v1.0.2.md"
catalog:
  artifact_id: "REQ-QUIVER-PRODUCT-CATALOG"
  version: "6.0.14"
  path: "../REQ-QUIVER-PRODUCT-CATALOG-v6.0.14.md"
derived_from:
  artifact_id: "REQ-QUIVER-PRODUCT-CATALOG"
  version: "6.0"
...
decisions:
  ...
  - decision_id: "DEC-20260903-072"
    date: "2026-09-03"
    actor: "technical-agent"
    change: "Reemplazar enlaces exactos a planes por navegación mediante IDs estables"
    reason: "Resolver PLAN-F-REV-01 sin crear un ciclo de versiones requerimiento-plan"
    impact: "Actualiza catálogo y navegación; no cambia specs, dependencias, criterios ni los 22 RQs"
  - decision_id: "DEC-20260903-076"
    date: "2026-09-03"
    actor: "project-owner"
    change: "Aprobar el requerimiento de la iniciativa F"
    reason: "Aprobación explícita de REQ-F 1.0.2, binding maestro 6.0.18 y PLAN-F 1.0.2"
    impact: "Crea REQ-F 1.0.3 aprobado; no cambia sus 22 requisitos, no decide G5 ni inicia implementación"
---
...
- [Catálogo segmentado v6.0.14](../REQ-QUIVER-PRODUCT-CATALOG-v6.0.14.md)
- [Catálogo de planes vigente](../../plans/README.md), que resuelve
  `PLAN-QUIVER-MASTER` y `PLAN-QUIVER-INIT-F-ORCHESTRATION-OPERATIONS` por ID
  estable.
