...
owner: "Fabri Juncal"
date: "2026-09-04"
supersedes: "./REQ-QUIVER-INIT-G-SCALE-ECOSYSTEM-v1.0.1.md"
catalog:
  artifact_id: "REQ-QUIVER-PRODUCT-CATALOG"
  version: "6.0.16"
  path: "../REQ-QUIVER-PRODUCT-CATALOG-v6.0.16.md"
derived_from:
  artifact_id: "REQ-QUIVER-PRODUCT-CATALOG"
  version: "6.0"
...
decisions:
  ...
  - decision_id: "DEC-20260903-080"
    date: "2026-09-03"
    actor: "technical-agent"
    change: "Agregar el plan específico de la iniciativa G como relación durable"
    reason: "La cadena F fue aprobada y el workflow habilita planificar G"
    impact: "Actualiza metadata y bindings; no cambia los 32 requisitos ni sus criterios"
  - decision_id: "DEC-20260904-003"
    date: "2026-09-04"
    actor: "project-owner"
    change: "Aprobar el requerimiento de la iniciativa G"
    reason: "Aprobación explícita de REQ-G 1.0.1, binding maestro 6.0.21 y PLAN-G 1.0.1"
    impact: "Crea REQ-G 1.0.2 aprobado; no cambia sus 32 requisitos, no satisface los gates de V89–V92 ni inicia implementación"
---
...
- [Catálogo segmentado v6.0.16](../REQ-QUIVER-PRODUCT-CATALOG-v6.0.16.md)
- [Catálogo de planes vigente](../../plans/README.md), que resuelve
  `PLAN-QUIVER-MASTER` y `PLAN-QUIVER-INIT-G-SCALE-ECOSYSTEM` por ID estable.
