---
title: "Quiver — Catálogo segmentado de especificaciones y requerimientos v6.0.11"
...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./REQ-QUIVER-PRODUCT-CATALOG-v6.0.10.md"
related_plans:
...
# Quiver — Catálogo segmentado de requerimientos v6.0.11

## 0. Cómo usar este catálogo

Este archivo reemplaza v6.0.10 como punto de entrada operativo. Vincula las
revisiones aprobadas 1.0.3 de A y 1.0.2 de B, C, D y E con sus planes. El
...
orden y gates es el
[plan maestro v6.0.15](../plans/PLAN-QUIVER-MASTER-v6.0.15.md).
