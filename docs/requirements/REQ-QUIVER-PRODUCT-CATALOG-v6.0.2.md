---
title: "Quiver — Catálogo segmentado de especificaciones y requerimientos v6.0.2"
...
owner: "Fabri Juncal"
date: "2026-09-03"
supersedes: "./REQ-QUIVER-PRODUCT-CATALOG-v6.0.1.md"
related_plans:
...
initiatives:
  - artifact_id: "REQ-QUIVER-INIT-A-ENGINE-TRUST"
    version: "1.0.1"
    path: "./initiatives/REQ-QUIVER-INIT-A-ENGINE-TRUST-v1.0.1.md"
...
# Quiver — Catálogo segmentado de requerimientos v6.0.2

## 0. Cómo usar este catálogo

Este archivo reemplaza v6.0.1 como punto de entrada operativo para vincular la
revisión 1.0.1 de la iniciativa A con su plan específico. El contenido continúa
distribuido en siete iniciativas versionables, alineadas con los hitos A–G del
roadmap, sin cambios de alcance.
...
|---|---|---:|---:|---|
| A | `REQ-QUIVER-INIT-A-ENGINE-TRUST` | V58–V62 | 46 | [REQ-QUIVER-INIT-A-ENGINE-TRUST-v1.0.1.md](./initiatives/REQ-QUIVER-INIT-A-ENGINE-TRUST-v1.0.1.md) |
...
orden y gates es el
[plan maestro v6.0.2](../plans/PLAN-QUIVER-MASTER-v6.0.2.md).
