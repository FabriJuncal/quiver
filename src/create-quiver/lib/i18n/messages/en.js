module.exports = {
  ...
  messages: {
    ...
    'config.error.missing_language_set': 'missing language for config language set. Use: npx create-quiver config language set <en|es>',
    'config.error.show_no_value': 'config language show does not accept a language value',
    ...
    'config.error.global_only_set': '--global is only supported by config language set. Use: npx create-quiver config language set <en|es> --global',
    'config.output.language': 'Language: {language}',
    'config.output.path': 'Path: {path}',
    'config.output.scope': 'Scope: {scope}',
    'config.output.show_title': 'Quiver config language',
    'config.output.source': 'Source: {source}',
    'config.output.updated_title': 'Quiver config language updated',
    'common.no': 'no',
    'common.none': 'none',
    ...
    'ai.error.missing_subcommand': 'missing ai subcommand. Use: npx create-quiver ai onboard | prepare-context | run | active-slice | status | resume | inspect | export | specs | slices | models | trace | plan | revise | repair-plan | review-plan | approve | approvals | agent | prompt-slice | execute-slice | execute-plan | doctor | pr',
    'ai.error.unsupported_active_slice_subcommand': 'unsupported ai active-slice subcommand: {command}. Supported tasks: status, reconcile',
    'ai.error.unsupported_collection_subcommand': 'unsupported ai {command} subcommand: {subcommand}. Supported tasks: list',
    'ai.error.unsupported_export_format': 'unsupported ai export format: {format}. Supported formats: json, markdown',
    'ai.error.unsupported_subcommand': 'unsupported ai subcommand: {command}. Supported tasks: onboard, prepare-context, run, active-slice, status, resume, inspect, export, specs, slices, models, trace, plan, revise, repair-plan, review-plan, approve, approvals, agent, prompt-slice, execute-slice, execute-plan, doctor, pr',
    'ai.error.unsupported_trace_subcommand': 'unsupported ai trace subcommand: {command}. Supported tasks: report',
    'ai.active_slice.error.reconcile_requires_dry_run': 'ai active-slice reconcile is dry-run first. Run `npx create-quiver ai active-slice reconcile --dry-run`.',
    ...
    'ai.lifecycle.error.close_requires_run': 'ai lifecycle close requires an active run or --run <id>',
    'ai.lifecycle.error.create_requires_input': 'ai lifecycle create requires --input <requirements.md>',
    'ai.lifecycle.error.unsupported_subcommand': 'unsupported ai lifecycle subcommand: {command}. Supported tasks: create, close',
    ...
    'ai.trace.wave': 'wave',
    'analyze.applied_writes': 'Applied writes: {count} files',
    ...
    'analyze.planned_writes': 'Planned writes: {count} files',
    ...
    'evidence.error.missing_path': 'missing evidence path. Use: npx create-quiver evidence show .quiver/evidence/<file.md>',
    'evidence.error.list_no_positional': 'evidence list does not accept positional arguments',
    'evidence.error.positional_before_separator': 'evidence run does not accept positional arguments before --',
    'evidence.error.unsupported_subcommand': 'unsupported evidence subcommand: {command}. Supported tasks: run, list, show',
    'evidence.exit_code': 'Exit code: {code}',
    'evidence.output': 'Output: {path}',
    'evidence.recorded': 'Quiver evidence recorded',
    'evidence.list.title': 'Quiver evidence artifacts',
    'evidence.list.empty': 'No evidence artifacts found in .quiver/evidence.',
    ...
    'init.applied_summary': 'Applied changes: create {create}, update {update}, preserve {preserve}',
    ...
    'migrate.applied_create': 'Applied create: {count}',
    'migrate.applied_preserve': 'Applied preserve: {count}',
    'migrate.applied_update': 'Applied update: {count}',
    'migrate.completed_for': 'Quiver migration completed for {path}',
    'migrate.changelog_hint': 'Review local contract changes with: {command}',
    'migrate.dry_run_hint': 'Preview first with: {command}',
    ...
    'migrate.write_warning': 'Warning: migrate can write project files.',
    ...
    'status_command.title': 'Quiver status',
    'status_command.state': 'State',
    'status_command.source': 'Source',
    'status_command.next_command': 'Next safe command',
    'status_command.specs': 'Specs',
    'status_command.blockers': 'Blockers',
    'status_command.read_only': 'Read-only: no files, providers, worktrees, or prompts were started.',
    'graph.empty.pending': 'No pending slices found.',
    'graph.empty.level': 'No pending slices found for level {level}. Run without --level to see all levels.',
    ...
    'next.also_ready_more': {
      one: 'Also ready: {count} more. Run: {command}',
      other: 'Also ready: {count} more. Run: {command}',
    },
    ...
    'plan.missing_estimates': {
      one: 'Estimated hours missing: {count} slice counted as 0h.',
      other: 'Estimated hours missing: {count} slices counted as 0h.',
    },
    ...
    'prepare.error.no_positional': 'prepare does not accept positional arguments',
    'prepare.output.auth': 'auth',
    'prepare.output.available': 'available ({command})',
    'prepare.output.checks': 'Checks: project docs, GitHub CLI, GitHub auth when SSH inputs are provided, SSH identity file when passed, provider CLI when passed',
    'prepare.output.doctor_warnings': 'Doctor warnings: {warnings}',
    'prepare.output.docs_absent': 'absent (not counted as debt)',
    'prepare.output.docs_present': 'present',
    'prepare.output.documentation_debt': 'documentation debt',
    'prepare.output.dry_run_note': 'Dry-run note: this command does not write files.',
    'prepare.output.framework_guidance': 'Framework guidance: packaged README_FOR_AI.md template',
    'prepare.output.github_cli': 'GitHub CLI:',
    'prepare.output.host_alias': 'host alias',
    'prepare.output.identity_file': 'identity file',
    'prepare.output.layout': 'Layout: {layout}',
    'prepare.output.missing': 'missing',
    'prepare.output.mode': 'Mode: {mode}',
    'prepare.output.next.fix_gh': 'Install GitHub CLI, then rerun `npx create-quiver prepare`.',
    'prepare.output.next.fix_ssh_identity': 'Fix the SSH identity file path, then rerun `npx create-quiver prepare`.',
    'prepare.output.next.gh_auth': 'Run `gh auth login`, then rerun `npx create-quiver prepare`.',
    'prepare.output.next.install_provider': 'Install the {provider} CLI, then rerun `npx create-quiver prepare --provider {provider}`.',
    'prepare.output.next.ready': 'Run `npx create-quiver doctor` for the layout contract, then `npx create-quiver ai prepare-context --dry-run` to preview the context drafts.',
    'prepare.output.next_safe_commands': 'Next safe commands:',
    'prepare.output.not_provided': 'not provided',
    'prepare.output.not_requested': 'not requested',
    'prepare.output.ok': 'ok',
    'prepare.output.omitted_by_default': 'omitted by default',
    'prepare.output.onboarding_context': 'Onboarding context:',
    'prepare.output.onboarding_risks': 'onboarding risks',
    'prepare.output.project': 'Project: {project}',
    'prepare.output.project_docs_copy': 'Project docs copy: {status}',
    'prepare.output.prompt_source': 'prompt source',
    'prepare.output.provider_cli': 'Provider CLI ({provider}):',
    'prepare.output.selected_docs': 'selected docs',
    'prepare.output.specs': 'Specs: {specs}',
    'prepare.output.ssh': 'SSH:',
    'prepare.output.title': 'Quiver prepare report',
    ...
    'handoff.error.missing_path': 'missing handoff or brief path. Use: npx create-quiver handoff check specs/<spec-slug>/HANDOFF.md or specs/<spec-slug>/slices/<slice-id>/EXECUTION_BRIEF.md',
    'handoff.error.missing_subcommand': 'missing handoff subcommand. Use: npx create-quiver handoff <check|create>',
    ...
    'handoff.error.unsupported_subcommand': 'unsupported handoff subcommand: {command}. Supported tasks: check, create',
    ...
    'spec.error.create_declined': 'spec create interactive approval declined. No files were written.',
    'spec.error.create_positional': 'spec create does not accept positional arguments; use --input <file> or --spec <slug>',
    'spec.error.dir_exists': 'spec directory already exists: {path}',
    'spec.error.dir_not_found': 'spec directory not found: {path}',
    'spec.error.missing_approved_input': 'missing reviewed and approved plan input: {path}',
    'spec.error.missing_dir': 'missing spec directory. Use: npx create-quiver spec validate specs/<spec-slug>',
    'spec.error.missing_dir_for_command': 'missing spec directory. Use: npx create-quiver spec <start|status|validate|close> <spec-dir>',
    'spec.error.missing_subcommand': 'missing spec subcommand. Use: npx create-quiver spec <create|start|status|validate|close>',
    'spec.error.review_canceled': '{reason}\nReview artifact: {path}',
    'spec.error.review_requires_tty': 'spec create --review requires an interactive terminal or an injected editor runner.\nReview artifact: {path}',
    'spec.error.validate_failed': 'spec validate failed for {path}',
    'slice.error.missing_subcommand': 'missing slice subcommand. Use: npx create-quiver slice <start|check|check-pr|scope|cleanup|refresh>',
    'slice.error.unsupported_subcommand': 'unsupported slice subcommand: {command}. Supported tasks: start, check, check-pr, scope, cleanup, refresh',
