module.exports = {
  ...
  messages: {
    ...
    'ai.label.code': 'Code',
    'ai.label.compatibility': 'Compatibility',
    'ai.label.governance_counts': 'Governance counts',
    ...
    'migrate.already_current': 'Quiver migration is already current for {path}. No files were written.',
    ...
    'migrate.verification_passed': 'Post-migration verification passed.',
    ...
    'flow.stage.governance-blocked': 'governance is fail-closed',
