...
function resolveInitPackageScripts(profile, options = {}) {
  const baseScripts = {
    ...
    'quiver:slice:start': 'npx create-quiver slice start',
    'quiver:slice:check': 'npx create-quiver slice check',
    'quiver:slice:check-pr': 'npx create-quiver slice check-pr',
    'quiver:slice:scope': 'npx create-quiver slice scope',
    'quiver:slice:cleanup': 'npx create-quiver slice cleanup',
    'quiver:slice:refresh': 'npx create-quiver slice refresh',
    ...
    'quiver:handoff:check': 'npx create-quiver handoff check',
    'quiver:handoff:create': 'npx create-quiver handoff create',
    'quiver:check-handoff': 'npx create-quiver check-handoff',
    'quiver:new-handoff': 'npx create-quiver new-handoff',
