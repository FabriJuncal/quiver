...
|-------|-------|--------|------|
| 01 | Token-Efficient AI Modes Guidance | Draft | [slice-01](./slices/slice-01-token-efficient-ai-modes-guidance/slice.json) |
| 02 | Decision Log | Draft | [slice-02](./slices/slice-02-decision-log-context-checkpoint/slice.json) |
