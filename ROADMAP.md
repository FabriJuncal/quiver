...
- **v31 — AI Model Catalog and Guided Agent Setup** (planned): known-model catalog, provider/model selectors, alias normalization, agent profile doctor/repair, shared model preflight, better provider errors, and release readiness live in `specs/quiver-v31-ai-model-catalog-agent-selection/`.
