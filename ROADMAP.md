...
## v0.16 — AI Model Catalog and Guided Agent Setup (in progress)

- **v31** — AI model catalog and guided agent setup: local known-model catalog for Codex, Claude, and Gemini, technical model id vs display name separation, provider/model selectors, alias normalization, agent profile doctor/repair dry-run, shared live-command model preflight, better provider errors, model listing, and docs/templates live in `specs/quiver-v31-ai-model-catalog-agent-selection/`. Release readiness is still pending.
...
- **v31 — AI Model Catalog and Guided Agent Setup** (in progress): known-model catalog, provider/model selectors, alias normalization, agent profile doctor/repair, shared model preflight, better provider errors, docs/templates, and release readiness live in `specs/quiver-v31-ai-model-catalog-agent-selection/`.
